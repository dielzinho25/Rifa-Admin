...
const CORE=['./index.html?v=15.5','./style.css?v=15.5','./admin.js?v=15.5','./firebase-config.js?v=15.5','./sorteio.html?v=15.5','./sorteio.js?v=15.5','./manifest.json?v=15.5','./icon-192.png','./icon-512.png'];
